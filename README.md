...
Steps:
Launch the simulator by opening:,    Tektronix4051.html
located in the 4051 Emulator directory.
If you do not already have the emulator, download it here: 👉 https://github.com/mmcgraw74/Tektronix-4051-Emulator
In the simulator:
...
Click IMPORT
Select VECTOR1.zip
The BASIC program listing at position 1 will appear.
Click CANCEL to close the window.
Then click AUTO LOAD
The simulator displays: FIND@5:1
OLD@5
The images are then displayed automatically, one after another, until the last one.

Viewing another archive
Once VECTOR1 has finished, you can load VECTOR2 by repositioning at point 5.
